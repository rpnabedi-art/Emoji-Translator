'--------------------------------------------------------------
'                        EDBexperiment12b.bas
'       Experiment 12b for the Educational Development Board
'                  (c) 1995-2006, MCS Electronics
'                        Fileversion 1.0
'--------------------------------------------------------------
'
'Purpose:
'This program shows a counter with anti bounce
'
'Conclusions:
'This program can be used since it counts adequate.
