...
'This file is intended to test the Mega1284P
'The M1284P has the JTAG enabled by default so you can not use
...
Print #1 , "second UART"                                    ' pind.3 is the second TX
...
Do
  ...
  End If
  Tel = Tel + 1
  Print "hello world " ; Tel ; "  " ; "  " ; Getadc(0)
  Waitms 500
  Toggle Portb.2
Loop
