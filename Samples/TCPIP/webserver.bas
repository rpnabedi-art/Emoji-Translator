...
$xa                                                         ' external memory access


'in debug mode to send some info to the terminal
Const Cdebug = 1
Const Authenticate = 1                                      ' use 1 to use authentication
...
#endif
Enable Interrupts
Config Tcpip = Int0 , Mac = 00.40.12.34.56.78 , Ip = 192.168.0.8 , Submask = 255.255.255.0 , Gateway = 192.168.0.1 , Localport = 1000 , Tx = $55 , Rx = $55


'dim used variables
Dim S As String * 140 , Shtml As String * 15 , Sheader As String * 30
...
'Usualy we start with creating a connection. This is also true for this demo.
