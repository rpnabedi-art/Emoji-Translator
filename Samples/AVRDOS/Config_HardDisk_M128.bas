...
Const Ata_databits = 16                                     ' 8 for CF-Card or 16 for Hard Disk

#if Ata_databits = 16
' Data Port High D8 - D15 on Hard Disk
Ata_data_high Alias Portc
Ata_data_high_in Alias Pinc
#endif
...
' Address Pins A0
Ata_pin_da0 Alias Pinb.5
Ata_port_da0 Alias Portb.5
Const Ata_da0_portonlyoutput = 0                            ' set to 1 on PortC of ATMega103


' Address Pins A1
Ata_pin_da1 Alias Pinb.6
Ata_port_da1 Alias Portb.6
Const Ata_da1_portonlyoutput = 0                            ' set to 1 on PortC of ATMega103


' Address Pins A2
Ata_pin_da2 Alias Pinb.7
Ata_port_da2 Alias Portb.7
...
Const Ata_cs1_connected = 1                                 ' Not used on Cf-Card => 0 and CE2 to High (VCC) level
Ata_pin_cs1 Alias Pinb.1
Ata_port_cs1 Alias Portb.1
