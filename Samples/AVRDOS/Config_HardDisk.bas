...
' Address Pins A0
Ata_pin_da0 Alias Pinc.4
Ata_port_da0 Alias Portc.4
Const Ata_da0_portonlyoutput = 0                            ' set to 1 on PortC of ATMega103

' Address Pins A1
Ata_pin_da1 Alias Pinc.3
Ata_port_da1 Alias Portc.3
...
Ata_pin_cs0 Alias Pinc.1
Ata_port_cs0 Alias Portc.1
Const Ata_cs0_portonlyoutput = 0                            ' set to 1 on PortC of ATMega103
Const Ata_cs0_activelevel = 0

' CS1 on HD-IDE / CE2 on CF-Card
Const Ata_cs1_connected = 1
Ata_pin_cs1 Alias Pinb.0
Ata_port_cs1 Alias Portb.0
Const Ata_cs1_portonlyoutput = 0                            ' set to 1 on PortC of ATMega103


' DIOR / OE
Ata_pin_dior Alias Pinc.5
Ata_port_dior Alias Portc.5
Const Ata_dior_portonlyoutput = 0                           ' set to 1 on PortC of ATMega103

' DIOW / WE
Ata_pin_diow Alias Pinc.6
Ata_port_diow Alias Portc.6
Const Ata_diow_portonlyoutput = 0                           ' set to 1 on PortC of ATMega103

' Reset
Const Ata_reset_connected = 1
Ata_pin_reset Alias Pinb.7
Ata_port_reset Alias Portb.7
Const Ata_reset_portonlyoutput = 0                          ' set to 1 on PortC of ATMega103
Const Ata_reset_activelevel = 0                             ' set to 1 on CF-Card; set to 0 on hard disk
