...
'Ddrd = &B11110011                                 'направление линий порта D: 1 - на вывод
...
Do
   ...
   If _usb_status._usb_rxc = 1 Then
    ...
    If Paket_dat = 1 Then
    Pwm1a = _usb_rx_buffer(2)                     'Данные 1 ШИМ могут быть 0-254
    End If

    If Paket_dat = 2 Then
    Pwm1b = _usb_rx_buffer(2)                     'Данные 2 ШИМ могут быть 0-254
    End If

    If Paket_dat = 3 Then
    Ocr2 = _usb_rx_buffer(2)                      'Данные 3 ШИМ могут быть 0-254
    End If
