...
' adapted to be used with ATMEGA328P and work with Example: dmx_slave_atxmega128a1.bas
'-----------------------------------------------------------------
...
Do
   ...
   For J = 1 To 8                                           ' this is the actual data
     Print Chr(ar(j));
   Next
   ' we have now sent 1 to address 1, 2 to address 2, 3 to address 3, etc.
